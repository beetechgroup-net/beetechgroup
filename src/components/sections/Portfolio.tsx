...
import beeTaskImg from "../../assets/projects/beetask.png";
...
const projects = [
  ...
  },
  {
    ...
    tags: ["Task Management", "Real-time", "Team Collaboration"],
    link: "https://beetask.beetechgroup.net",
    icon: ListTodo,
    image: beeTaskImg,
  },
];
...
export function Portfolio() {
  ...
  return (
    <section
      id="portfolio"
      className="py-20 md:py-32 bg-bee-dark overflow-hidden"
    >
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 md:p-12 z-10 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
                <div className="max-w-xl">
                  ...
                  <p className="text-gray-300 text-lg mb-6 leading-relaxed">
                    {t(
                      `portfolio.projects.${projects[currentIndex].key}.description`,
                    )}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {projects[currentIndex].tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-4 py-1.5 bg-white/10 backdrop-blur-md rounded-full text-sm font-medium text-white border border-white/10"
                      >
                        {tag}
                      </span>
                    ))}
