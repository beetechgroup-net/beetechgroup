  ...
  en: {
    translation: {
      ...
      hero: {
        ...
        description:
          "Bee Tech Group is a premier software development agency crafting high-performance digital experiences. We turn complex challenges into elegant solutions.",
      ...
      services: {
        ...
        highlight: "Expertise",
        description:
          "We provide comprehensive software development services tailored to your specific business needs. From initial concept to final deployment.",
        items: {
          webDev: {
      ...
      portfolio: {
        ...
        projects: {
          beeFan: {
            description:
              "A comprehensive fan engagement platform connecting artists with their audience through exclusive content and interactive experiences.",
          },
          beeExperiences: {
            description:
              "Immersive digital experiences platform designed to create memorable interactions for events and brands.",
          },
          beeTask: {
            description:
              "A comprehensive project management tool featuring task tracking, time management, real-time chat, and team collaboration capabilities.",
          },
        },
      },
      about: {
  ...
  pt: {
    translation: {
      ...
      hero: {
        ...
        description:
          "Bee Tech Group é uma agência de desenvolvimento de software líder, criando experiências digitais de alta performance. Transformamos desafios complexos em soluções elegantes.",
      ...
      services: {
        ...
        highlight: "Expertise",
        description:
          "Fornecemos serviços abrangentes de desenvolvimento de software adaptados às necessidades específicas do seu negócio. Do conceito inicial à implantação final.",
        items: {
          webDev: {
      ...
      portfolio: {
        ...
        highlight: "Destaque",
        description:
          "Explore nosso portfólio de projetos de sucesso onde ajudamos empresas e criadores a alcançar seus objetivos digitais.",
        viewGithub: "Ver no GitHub",
        projects: {
          beeFan: {
            description:
              "Uma plataforma abrangente de engajamento de fãs conectando artistas com seu público através de conteúdo exclusivo e experiências interativas.",
          },
          beeExperiences: {
            description:
              "Plataforma de experiências digitais imersivas projetada para criar interações memoráveis para eventos e marcas.",
          },
          beeTask: {
            description:
              "Um gerenciador de tarefas completo com rastreamento de tempo, chat em tempo real e ferramentas de colaboração para equipes.",
          },
        },
      },
      about: {
      ...
      contact: {
        ...
        highlight: "Incrível",
        description:
          "Tem um projeto em mente? Adoraríamos ouvir sobre ele. Envie-nos uma mensagem e vamos começar a conversa.",
      ...
      footer: {
        tagline:
          "Transformando ideias em realidade digital. Serviços de desenvolvimento de software premium para a web moderna.",
        services: "Serviços",
        company: "Empresa",
        connect: "Conectar",
        links: {
